...
<template>
    <header class="bg-gray-900 border-gray-900 shadow-md border-bottom border-b-2 sticky top-0 z-20">
        <nav class="px-6 mx-auto flex max-w-7xl px-6 lg:px-8 items-center justify-between py-3" aria-label="Global">
            <div class="flex items-center gap-x-12">
                <div class="-m-1.5 p-1.5 flex gap-x-4 items-center">
                    <span class="sr-only">John MacElheron</span>
                    <NuxtLink class="cursor-pointer hover:opacity-80" :to="'/'">
                        <img
                    ...
                    <div class="text-gray-500 notifications">
                        <div class="smsdots flex items-center w-full justify-center opacity-0 transition-opacity duration-100">
                            <div class="sk-three-bounce-sml">
                                <div class="sk-bounce-1 sk-child-sml"></div>
                                <div class="sk-bounce-2 sk-child-sml"></div>
                                <div class="sk-bounce-3 sk-child-sml"></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex lg:gap-x-12">
                    <a href="#faveProjects" class="text-sm font-semibold leading-6 text-white hover:opacity-75">Projects</a>
                </div>
                <div class="flex lg:gap-x-12">
                    <a href="#aboutMe" class="text-sm font-semibold leading-6 text-white hover:opacity-75">About</a>
                </div>
            </div>
            ...
            <div ref="mobileMenu" class="mobile-menu bg-gray-900 fixed inset-y-0 right-0 w-full overflow-y-auto bg-white px-6 py-3 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                ...
                <div class="mt-6 flow-root">
                    ...
                    <div class="space-y-2 py-6">
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-emerald-950 hover:opacity-9">Projects</a>
                    </div>
                    <div class="space-y-2 py-6">
                        <a href="#" class="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-emerald-950 hover:opacity-9">Projects</a>
                    </div>
